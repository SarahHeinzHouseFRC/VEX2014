...
#pragma config(Sensor, I2C_5,  driveRight,     sensorNone)
#pragma config(Motor,  port1,           rightArm1,     tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port2,           intakeRight,   tmotorVex393, openLoop)
...
#pragma config(Motor,  port5,           driveLeftBack, tmotorVex393, openLoop)
#pragma config(Motor,  port6,           driveRightFront, tmotorVex393, openLoop)
#pragma config(Motor,  port7,           driveRightBack, tmotorVex393, openLoop)
#pragma config(Motor,  port8,           LiftRight,     tmotorVex393, openLoop, reversed, encoder, encoderPort, I2C_1, 1000)
#pragma config(Motor,  port9,           LiftLeft,      tmotorVex393, openLoop, encoder, encoderPort, I2C_2, 1000)
...
task autonomous()
{
	...
	redBigballs();
		...
		displayLCDCenteredString(1, "here human");
	}
}
